        ...
        <div className="flex gap-2"> 
          <nav>
            <ul className="flex space-x-6"> 
              <li><a href="#landing_page" onClick={AdminFormBtn}  className="bg-green-500 px-4 py-2 text-sm text-white rounded hover:bg-green-600">Logout</a></li>
            </ul>
          </nav>
        </div>
      </header>
        ...
        <div className="bg-white shadow rounded-lg p-6">
          ...
          <form className="space-y-6">
            ...
            <div className="flex justify-between mt-6">
              <button
                type="button"
               href="#adminDashboard" onClick={adminBtn}  className="bg-green-500 px-4 py-2 text-sm text-white rounded hover:bg-green-600">
                Cancel
              </button>
              <button
                type="submit"
