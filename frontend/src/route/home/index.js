   ...
   <div className="bg-gray-100 min-h-screen flex flex-col">
      ...
      <header className="bg-blue-500 text-white py-4 shadow-md">
        <div className="container mx-auto flex justify-between items-center px-4">
          ...
          <button onClick={hubungiBtn} className="bg-green-500 px-4 py-2 rounded-lg text-white hover:bg-green-600 transition duration-300 shadow">
            Hubungi Kami
          </button>
        </div>
      </header>
      ...
      <section className="bg-blue-100 flex-grow py-20">
        <div className="container mx-auto flex flex-col md:flex-row items-center px-4">
          ...
          <div className="text-center md:text-left md:w-1/2">
            <h2 className="text-4xl font-bold text-blue-600 mb-4">Laundry POS</h2>
            <p className="text-lg text-gray-700 mb-6 leading-relaxed">
            Laundry POS, Laundry Express 24 jam, 3 jam, 6 jam, 12 jam.
            Cepat, Bersih, dan Terpercaya. Tersedia paket kilat sesuai kebutuhan Anda.
            </p>
